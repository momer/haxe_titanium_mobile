...
{	
	...
	public static var attributedHintText:AttributedString;
	...
	public static var borderStyle:Float;
	
	public static var clearButtonMode:Float;
	...
	public static var leftButtonMode:Float;
	
	public static var leftButtonPadding:Float;
	
	public static var maxLength:Float;
	
	public static var minimumFontSize:Float;
	
	public static var paddingLeft:Float;
	
	public static var paddingRight:Float;
	
	public static var passwordMask:Bool;
	
	public static var returnKeyType:Float;
	
	public static var rightButton:Dynamic;
	
	public static var rightButtonMode:Float;
	
	public static var rightButtonPadding:Float;
	
	public static var selection:TextFieldSelectedParams;
