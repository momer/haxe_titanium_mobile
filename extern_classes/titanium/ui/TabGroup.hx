...
{	
	public static var activeTab:Tab;
	
	public static var activeTabBackgroundColor:String;
	
	public static var activeTabBackgroundDisabledColor:String;
	
	public static var activeTabBackgroundDisabledImage:String;
	
	public static var activeTabBackgroundFocusedColor:String;
	
	public static var activeTabBackgroundFocusedImage:String;
	
	public static var activeTabBackgroundImage:String;
	
	public static var activeTabBackgroundSelectedColor:String;
	
	public static var activeTabBackgroundSelectedImage:String;
	
	public static var activeTabIconTint:String;
	
	public static var activity:Activity;
	
	public static var allowUserCustomization:Bool;
	
	public static var barColor:String;
	
	public static var editButtonTitle:String;
	...
	public static var smoothScrollOnTabClick:Bool;
	
	public static var swipeable:Bool;
	
	public static var tabDividerColor:String;
	
	public static var tabDividerWidth:Dynamic;
	
	public static var tabHeight:Dynamic;
	
	public static var tabs:Array<Tab>;
	
	public static var tabsAtBottom:Bool;
	
	public static var tabsBackgroundColor:String;
	
	public static var tabsBackgroundDisabledColor:String;
	
	public static var tabsBackgroundDisabledImage:String;
	
	public static var tabsBackgroundFocusedColor:String;
	
	public static var tabsBackgroundFocusedImage:String;
	
	public static var tabsBackgroundImage:String;
	
	public static var tabsBackgroundSelectedColor:String;
	
	public static var tabsBackgroundSelectedImage:String;
	
	public static var tabsTintColor:String;
